...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        points = take_turn(strat, opponent_score, dice)
        if player == 0:
            score0 += points
        else:
            score1 += points
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1, previous_high = previous_high, previous_score = previous_score):
            if who == 0:
                ...
                score = score1
            recent_gain = score - previous_score
            if previous_high < recent_gain:
                if recent_gain == 1:
                    print("1 point! That's the biggest gain yet for Player", who)
                else:
                    print(recent_gain, "points! That's the biggest gain yet for Player", who)
                previous_high = recent_gain
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if bacon_strategy(score, opponent_score, margin, num_rolls) == 0 or (is_swap(score + free_bacon(opponent_score), opponent_score) and score < opponent_score):
        return 0
    else:
        return num_rolls
